...
export default function TutanakOlusturucuPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] flex flex-col text-gray-900">
      <header className="bg-[#1F3860] text-white px-6 py-4 flex items-center justify-between shadow-md">
        <div>
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#C5A059] hover:bg-[#B08A3E] text-[#1F3860] font-semibold px-5 py-2.5 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
        >
          <Download size={18} />
      ...
      <main className="flex-1 grid grid-cols-1 lg:grid-cols-[minmax(380px,45%)_1fr] overflow-hidden">
